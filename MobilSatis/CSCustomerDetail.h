...
//  MobilSatis
//
//  Created by ABH on 5/11/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import "CSCustomer.h"

@interface CSCustomerDetail : CSCustomer{
    NSString *saleManager;
    NSString *saleChief;
    NSString *customerManager;
    NSString *salesRepresentative;
    NSString *marketDeveloper;
    NSString *status;
    NSString *title;
    NSString *mainStreet;
    NSString *street;
    ...
    NSString *taxOffice;
    NSString *taxNumber;
    NSString *certificateOffice;
    NSString *certificateNumber;
    NSString *customerGroup;
    NSString *sesGroup;
    NSString *customerFeature; //check this out
    NSString *customerPosition;
    NSString *locationGroup;
    NSString *efesContract;
    NSString *m2;
    NSString *cashRegister;
    NSString *openM2;
    NSString *closeM2;
}
